...
body = asana_preview.TeamGidAddUserBody() # TeamGidAddUserBody | The user to add to the team.
...
# **create_team**
> TeamResponseData create_team(body, limit=limit, offset=offset, opt_fields=opt_fields)
...
# create an instance of the API class
api_instance = asana_preview.TeamsApi(asana_preview.ApiClient(configuration))
body = asana_preview.TeamsBody1() # TeamsBody1 | The team to create.
...
try:
    # Create a team
    api_response = api_instance.create_team(body, limit=limit, offset=offset, opt_fields=opt_fields)
    pprint(api_response)
except ApiException as e:
...
# **get_team**
> TeamResponseData get_team(team_gid, limit=limit, offset=offset, opt_fields=opt_fields)
...
try:
    # Get a team
    api_response = api_instance.get_team(team_gid, limit=limit, offset=offset, opt_fields=opt_fields)
    pprint(api_response)
except ApiException as e:
...
# create an instance of the API class
api_instance = asana_preview.TeamsApi(asana_preview.ApiClient(configuration))
body = asana_preview.TeamGidRemoveUserBody() # TeamGidRemoveUserBody | The user to remove from the team.
team_gid = '159874' # str | Globally unique identifier for the team.
...
# **update_team**
> TeamResponseData update_team(body, limit=limit, offset=offset, opt_fields=opt_fields)
...
# create an instance of the API class
api_instance = asana_preview.TeamsApi(asana_preview.ApiClient(configuration))
body = asana_preview.TeamsBody() # TeamsBody | The team to update.
limit = 50 # int | Results per page. The number of objects to return per page. The value must be between 1 and 100. (optional)
offset = 'eyJ0eXAiOJiKV1iQLCJhbGciOiJIUzI1NiJ9' # str | Offset token. An offset to the next page returned by the API. A pagination request will return an offset token, which can be used as an input parameter to the next request. If an offset is not passed in, the API will return the first page of results. 'Note: You can only pass in an offset that was returned to you via a previously paginated request.' (optional)
opt_fields = ['[\"description\",\"edit_team_name_or_description_access_level\",\"edit_team_visibility_or_trash_team_access_level\",\"guest_invite_management_access_level\",\"html_description\",\"join_request_management_access_level\",\"member_invite_management_access_level\",\"name\",\"organization\",\"organization.name\",\"permalink_url\",\"team_member_removal_access_level\",\"visibility\"]'] # list[str] | This endpoint returns a compact resource, which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include. (optional)
...
try:
    # Update a team
    api_response = api_instance.update_team(body, limit=limit, offset=offset, opt_fields=opt_fields)
    pprint(api_response)
except ApiException as e:
