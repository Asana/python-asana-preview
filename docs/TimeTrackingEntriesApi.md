...
with asana_preview.ApiClient(configuration) as api_client:
    ...
    opt_fields = ["created_at","created_by","task","entered_on","duration_minutes"] # [str] | This endpoint returns a compact resource, which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include. (optional)
...
with asana_preview.ApiClient(configuration) as api_client:
    ...
    opt_fields = ["entered_on","duration_minutes","created_by"] # [str] | This endpoint returns a compact resource, which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include. (optional)
