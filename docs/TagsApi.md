...
body = asana_preview.TagsBody() # TagsBody | The tag to create.
...
# create an instance of the API class
api_instance = asana_preview.TagsApi(asana_preview.ApiClient(configuration))
body = asana_preview.WorkspaceGidTagsBody() # WorkspaceGidTagsBody | The tag to create.
...
# **delete_tag**
> EmptyResponseData delete_tag(tag_gid, limit=limit, offset=offset)
...
try:
    # Delete a tag
    api_response = api_instance.delete_tag(tag_gid, limit=limit, offset=offset)
    pprint(api_response)
except ApiException as e:
...
# **get_tag**
> TagResponseData get_tag(tag_gid, limit=limit, offset=offset, opt_fields=opt_fields)
...
try:
    # Get a tag
    api_response = api_instance.get_tag(tag_gid, limit=limit, offset=offset, opt_fields=opt_fields)
    pprint(api_response)
except ApiException as e:
...
# **update_tag**
> TagResponseData update_tag(tag_gid, limit=limit, offset=offset, opt_fields=opt_fields)
...
try:
    # Update a tag
    api_response = api_instance.update_tag(tag_gid, limit=limit, offset=offset, opt_fields=opt_fields)
    pprint(api_response)
except ApiException as e:
