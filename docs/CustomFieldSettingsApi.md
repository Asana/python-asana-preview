# asana_preview.CustomFieldSettingsApi
...
> GetCustomFieldSettingsForProject200Response get_custom_field_settings_for_portfolio(portfolio_gid)
...
from asana_preview.api import custom_field_settings_api
...
with asana_preview.ApiClient(configuration) as api_client:
    ...
    api_instance = custom_field_settings_api.CustomFieldSettingsApi(api_client)
    ...
    try:
        # Get a portfolio's custom fields
        api_response = api_instance.get_custom_field_settings_for_portfolio(portfolio_gid)
        pprint(api_response)
    ...
    try:
        # Get a portfolio's custom fields
        api_response = api_instance.get_custom_field_settings_for_portfolio(portfolio_gid, opt_pretty=opt_pretty, limit=limit, offset=offset, opt_fields=opt_fields)
        pprint(api_response)
    except asana_preview.ApiException as e:
        print("Exception when calling CustomFieldSettingsApi->get_custom_field_settings_for_portfolio: %s\n" % e)
```
...
> GetCustomFieldSettingsForProject200Response get_custom_field_settings_for_project(project_gid)
...
with asana_preview.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a project's custom fields
        api_response = api_instance.get_custom_field_settings_for_project(project_gid, opt_pretty=opt_pretty, limit=limit, offset=offset, opt_fields=opt_fields)
        pprint(api_response)
    except asana_preview.ApiException as e:
        print("Exception when calling CustomFieldSettingsApi->get_custom_field_settings_for_project: %s\n" % e)
```
